...
public class Main {
	...
	public static void main (String[]args) {
		...
		boolean count211 = true;
		double payout211 = 5.5;
	...
	DecimalFormat f = new DecimalFormat("###.###");
         ...
         System.out.println(wp(0)*wp(0)*lp(0)*dp(0)*12*5.5*16);
...
//			arr[i][0] *= 0.8;
			...
			arr[i][3] = arr[i][0]*payout31+arr[i][1]*payout301+arr[i][2]*payout40+wp(0)*wp(0)*lp(0)*dp(0)*24*payout211;
			arr[i][4]= i*10; 
			arr[i][5]= arr[i][3]*i;
